    ...
    return (
        <>
            <div className="footer">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="48" height="48" color="#78ae7e" fill="none">
                ...
                <svg style={{ marginBottom: '10px' }} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="58" height="58" color="#68936a" fill="none">
                ...
                <svg style={{ marginBottom: '20px' }} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="68" height="68" color="#527a28" fill="none">
                ...
                <svg style={{ marginBottom: '30px' }} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="78" height="78" color="#466e25" fill="none">
                ...
                <svg style={{ marginBottom: '40px' }} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="88" height="88" color="#407245" fill="none">
                ...
                <svg style={{ marginBottom: '50px' }} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="98" height="98" color="#2a5920" fill="none">
                ...
                <svg style={{ transform: 'rotate(80deg)', transformOrigin: 'center', marginBottom: '95px' }} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="98" height="98" color="#2a5920" fill="none" >
                ...
                <form>
                    <div>
                        ...
                        <input style={{ marginRight: '20px' }} type="email" placeholder="Enter Email" />
                        <button onClick={handleClick} type="submit">Subscribe</button>
                    </div>
                </form>
